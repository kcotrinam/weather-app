...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "images/error.jpg");
...
/* harmony import */ var _img_error_jpg__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../img/error.jpg */ "./src/img/error.jpg");
                          ...
                          <div class="error-container">
                            <div class="error">
                              ...
                              <div class="error__img">
                                <img src="${_img_error_jpg__WEBPACK_IMPORTED_MODULE_2__.default}" alt="What?! meme"/>
                              </div>
                            </div>
...
const getData = async (city) => {
  const response = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=${_global__WEBPACK_IMPORTED_MODULE_0__.apiKey}`);
